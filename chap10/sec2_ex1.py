...
class Politician(Person):
    ...
    def might_agree(self, other):
        ...
        return (self._party == other._party) or (
            self._party is None or other._party is None
        )


p1 = Politician(name="hoang", party="abc")
p2 = Politician(name="minh", party="xyz")
p1.set_birthday(datetime.date(day=15, month=3, year=2000))

print(f"Age of {p1.get_name()} in days: ", p1.get_age())
print("Agree?", p1.might_agree(p2))
